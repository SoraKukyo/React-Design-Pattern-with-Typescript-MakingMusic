...
// Even though type inference can be done by default in Typescript,
// explicitly define type can save the compile a lot of work and the complilation process faster
// And one more thing, it can prevent error when we make a typos XD
